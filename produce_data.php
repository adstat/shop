...
//echo "<pre>";print_r($product_2);exit;
...
foreach($product_2 as $pkey=>$pvalue){
    ...
    //$produce_group_work_arr[$pvalue['produce_group_id']]['products'] = array();
    ...
    foreach($pvalue['product_barcode'] as $pbkey=>$pbvalue){
        ...
        if($pvalue['produce_type_id'] == 1){
            ...
            if(!($product_produce_time >= $produce_work_day_start && $product_produce_time <= $produce_work_day_end)  ){
                ...
                $chenghao2 = (string)substr($pbvalue, 9,2);
                if(isset($produce_group_work_arr[$pvalue['produce_group_id']]['products'][$chenghao]['product'][$pvalue['product_id']])){
                    $produce_group_work_arr[$pvalue['produce_group_id']]['products'][$chenghao]['product'][$pvalue['product_id']]['quantity']++;
                    $produce_group_work_arr[$pvalue['produce_group_id']]['products'][$chenghao]['product'][$pvalue['product_id']]['product_time'][] = $product_produce_time;
                }
                else{
                    if($pvalue['weight_inv_flag'] == 0){
                        $produce_group_work_arr[$pvalue['produce_group_id']]['products'][$chenghao]['product'][$pvalue['product_id']] = array(
                            "product_id" => $pvalue['product_id'],
                            "name" => $pvalue['name'],
                            "quantity" => $pvalue['quantity'],
                            'product_time' => array($product_produce_time)
                ...
                //$produce_group_work_arr[$pvalue['produce_group_id']][$chenghao]['product'][$pvalue['product_id']]['product_time'][] = $product_produce_time;
            }
        }
        ...
        if($pvalue['produce_type_id'] == 3){
            $chenghao = "3_" . (string)substr($pbvalue, 9,2);
            $chenghao2 = (string)substr($pbvalue, 9,2);
            if(isset($produce_group_work_arr[$pvalue['produce_group_id']]['products'][$chenghao]['product'][$pvalue['product_id']])){
                $produce_group_work_arr[$pvalue['produce_group_id']]['products'][$chenghao]['product'][$pvalue['product_id']]['quantity']++;
                $produce_group_work_arr[$pvalue['produce_group_id']]['products'][$chenghao]['product'][$pvalue['product_id']]['product_time'][] = $product_produce_time;
...
//echo "<pre>";print_r($produce_group_work_arr);exit;
    ...
    <body>
        ...
        <table>
            ...
            <?php foreach($produce_group_work_arr as $key=>$value){?>
                <?php if($key!=999){ ?>
                    <?php foreach($value['products'] as $key1=>$value1){?>
