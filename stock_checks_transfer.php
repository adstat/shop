...
<div id="message" class="message style_light" style="">搬仓移库</div>
...
<!--    </table>-->
    ...
    <div style="margin-right: 70px;">
        ...
        <input style="float: right" class="input_default" id="code" type="text" value="" placeholder="移至区域">
    </div>
...
<script>
                ...
                if(response){
                    ...
                    $.each(jsonData, function(index,value){
                        ...
                        if(value.status == 0 ){
                            ...
                            html += "<td>";
                            html +='<input class="qtyopt" type="button" value="移库"  style="font-size: 0.8rem ;width: 2.5rem; " id="Inventory'+value.pallet_number +'" onclick="javascript:addStockMoveTransfer('+ value.pallet_number +')" >';
                            html +="</td>";
                        }
    ...
    function addStockMoveTransfer(pallet_number) {
        ...
        $.ajax({
            type : 'POST',
            url : 'invapi.php?method=addStockMoveTransfer&isback='+$('#isBack').val(),
            data : {
                method : 'addStockMoveTransfer',
                data:{
                    code:code,
                    pallet_number:pallet_number,
                    warehouse_id:warehouse_id,
