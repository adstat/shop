        ...
        <div class="row">
            <div class="col">
                <div id="fastmove_order_frame" class="input-group  input-group-md">
                    <select name="switchSelect" id="setType" class="custom-select-md">
                        <option value="1" selected>扫描</option>
                        <option value="2">手输</option>
                    </select>
                    <input type="hidden" class="fm_frame_vg_list" />
                    <input  name="product" id="frame_vg_list" type="text" value="" class="form-control col-xs-8" placeholder="请输入商品或条码" aria-label="Large" aria-describedby="inputGroup-sizing-sm">
...
function putNavList(product,checkCabinet=false) {
        ...
        check_produvt_arr = [];
        // var frequency=getProductFrequency(vv.product_name);
...
// var switchSelect=$("select[name='switchSelect']").val();
$("select[name='switchSelect']").on('change',function () {
    str=$(this).val();
    alert(str);
});
/*
