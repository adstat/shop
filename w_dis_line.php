...
<form name= "select" method="post">
    ...
    <?php if($_COOKIE['warehouse_id'] == 12):?>
        <div id="sec2" style="display:inline; margin:0.5em auto">
            <span> 分拣账号仓库选择:</span>
                ...
                if(response){
                    ...
                    $.each(jsonData, function(index, value){
                        ...
                        if(value.s_weight_inv_flag > 0){
                            html += '<option value='+ value.order_id +'@'+value.quantity+'@'+value.old_order_id+'>重' + value.order_id + '(' + value.quantity_zheng + '+' + value.quantity_san + ')'+name +'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  '+'#'+value.old_order_id+' &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; '+value.date_added+'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' + district + groupname + spcTagSDG + value.shipping_address_1+'</option>';
                        }
                        else {
                            if (warehouse_repack == 0) {
...
// console.log(value.warehouse_id);
                                ...
                                if (parseInt(value.warehouse_id) == parseInt(warehouse_id)) {
                                    if (value.is_urgent == 1) {
                                        html += '<option value=' + value.order_id + '@' + value.quantity +'@'+value.old_order_id+ ' style="color: red">['+value.title+'][加急]' + value.order_id + '(' + value.quantity_zheng + '+' + value.quantity_san + ')' + name +'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  '+'#'+value.old_order_id+ doInfo +'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ' + value.date_added + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' + district + groupname + spcTagSDG + value.shipping_address_1 + '</option>';
                                    } else {
                                        html += '<option value=' + value.order_id + '@' + value.quantity +'@'+value.old_order_id+ ' >['+value.title+']' + value.order_id + '(' + value.quantity_zheng + '+' + value.quantity_san + ')' + name +'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  '+'#'+value.old_order_id+ doInfo +'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;   ' + value.date_added + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' + district + groupname + spcTagSDG + value.shipping_address_1 + '</option>';
                                    }
                                } else {
                                    if (value.is_urgent == 1) {
                                        html += '<option value=' + value.order_id + '@' + value.quantity +'@'+value.old_order_id+ ' style="color: blue">['+value.title+'][加急]' + value.order_id + '(' + value.quantity_zheng + '+' + value.quantity_san + ')' + name +'&emsp;&emsp;&nbsp;  '+'#'+value.old_order_id+ doInfo +'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ' + value.date_added + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' + district + groupname + spcTagSDG + value.shipping_address_1 + '</option>';
                                    } else {
                                        html += '<option value=' + value.order_id + '@' + value.quantity +'@'+value.old_order_id+ ' style="color: blue">['+value.title+']' + value.order_id + '(' + value.quantity_zheng + '+' + value.quantity_san + ')' + name +'&emsp;&emsp;&nbsp;  '+'#'+value.old_order_id+ doInfo +'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ' + value.date_added + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' + district + groupname + spcTagSDG + value.shipping_address_1 + '</option>';
                                    }
                                }
                            ...
                            if (warehouse_repack == 1 && user_repack == 0  && value.quantity_zheng>=0 ) {
                                ...
                                if (value.is_urgent == 1) {
                                    html += '<option value=' + value.order_id + '@' + value.quantity_zheng +'@'+value.old_order_id+  ' style="color: red">['+value.title+'][加急]' + value.order_id + '(' + value.quantity_zheng + '+' + value.quantity_san + ')' + name +'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  '+'#'+value.old_order_id+ doInfo +'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ' + value.date_added + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' + district + groupname + spcTagSDG + value.shipping_address_1 + '</option>';
                                } else {
                                    html += '<option value=' + value.order_id + '@' + value.quantity_zheng +'@'+value.old_order_id+  ' >['+value.title+']' + value.order_id +'(' + value.quantity_zheng + '+' + value.quantity_san + ')' + name +'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  '+'#'+value.old_order_id+ doInfo +'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ' + value.date_added + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' + district + groupname + spcTagSDG + value.shipping_address_1 + '</option>';
                                }
                            }
                            if (warehouse_repack == 1 && user_repack == 1  &&  value.quantity_san >= 0 ) {

                                if (value.is_urgent == 1) {
                                    html += '<option value=' + value.order_id + '@' + value.quantity_san +'@'+value.old_order_id+  ' style="color: red">['+value.title+'][加急]' + value.order_id + '(' + value.quantity_zheng + '+' + value.quantity_san + ')' + name+'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  '+'#'+value.old_order_id+ doInfo +'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ' + value.date_added + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' + district + groupname + spcTagSDG + value.shipping_address_1 + '</option>';
                                } else {
                                    html += '<option value=' + value.order_id + '@' + value.quantity_san +'@'+value.old_order_id+  ' >['+value.title+']' + value.order_id +'(' + value.quantity_zheng + '+' + value.quantity_san + ')' + name +'&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;  '+'#'+value.old_order_id+ doInfo +'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  ' + value.date_added + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ' + district + groupname + spcTagSDG + value.shipping_address_1 + '</option>';
                                }
                            }
                        ...
                        if (jsonData == 1) {
                            ...
                            if (jsonData.soStatus != '') {
                                ...
                                $.each(jsonData.doLists, function (index1, value1) {
                                    var singleInfor = doInformation[index1];
                                    html3 += '<tr><td colspan="6"></td></tr>';
                                    html3 += '<tr><th>' + value1.deliver_order_id + '</th><th>' + value1.doWarehouse + '</th><th>' + value1.inventory_name + '</th><th>' + value1.deliver_date + '</th><th>' + value1.order_name + '</th><th>' + value1.deliver_name + '</th></tr>';
