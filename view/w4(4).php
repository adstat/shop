    ...
    if(product_quantity >0){
        $.ajax({
            ...
            success : function (response, status, xhr){
                ...
                // console.log(allData);
                //分拣数量
                var  nowNumber=parseInt($("#calcNum_"+container_id+'_'+product_id).text());
                console.log(nowNumber);
                //总数
                var  countNumber=parseInt($("#calcquantity_"+container_id+"_"+product_id).text());
