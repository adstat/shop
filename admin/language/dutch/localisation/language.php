...
// Entry
$_['entry_name']        = 'Taal';
$_['entry_code']        = 'ISO Code';
$_['entry_locale']      = 'Locale';
$_['entry_image']       = 'Afbeelding';
$_['entry_directory']   = 'Directorie';
$_['entry_status']      = 'Status';
$_['entry_sort_order']  = 'Sorteervolgorde:';

// Help
$_['help_code']         = 'Landcode, bv. nl (Niet wijzigen wanneer dit uw Default taal is.).';
$_['help_locale']       = 'bv: nl_NL.ISO_8859-1,nl_NL,nl_NL,dutch';
$_['help_image']        = 'bv: nl.png';
$_['help_directory']    = 'Naam van de directory, bv. dutch (hoofdletter gevoelig)';
$_['help_status']       = 'Weergeven/verbergen in de taalkeuzemodule aan winkelzijde';
...
$_['error_directory']   = 'Waarschuwing: Directory verplicht!';
