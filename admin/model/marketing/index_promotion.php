        ...
        if(!$warehouse_id){
            ...
            if(!isset($data['set-area'])){
                ...
                foreach($data['product'] as $product){
                    ...
                    $insert = "INSERT INTO oc_product_special (`product_id`,`warehouse_id`,`area_id`,`price`,`maximum`,`promo_title`,`date_start`,`date_end`)
                    values('".$product['product_id']."','".$warehouse_id."','".$area_id."','".$product['price']."','".$product['maximum']."','".$product['promo_title']."','".$product['date_start']."','".$product['date_end']."')";
                    $this->db->query($insert);
                }
            }else{
                foreach($data['set-area'] as $area){
                    foreach($data['product'] as $product){
                        ...
                        $insert = "INSERT INTO oc_product_special (`product_id`,`warehouse_id`,`area_id`,`price`,`maximum`,`promo_title`,`date_start`,`date_end`)
                        values('".$product['product_id']."','".$warehouse_id."','".$area."','".$product['price']."','".$product['maximum']."','".$product['promo_title']."','".$product['date_start']."','".$product['date_end']."')";
                        $this->db->query($insert);
                    }
                }
            }
