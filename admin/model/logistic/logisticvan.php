...
{
    public function getOrdersByAreaByDate($classify,$area_id = false,$search_date ,$station_id=false){
        if($classify == 1) {
        ...
        where lao.order_id is null and A.order_status_id in (2,5,6,8) and A.order_deliver_status_id in (1,2) and A.area_id = '$area_id' and A.deliver_date = '$search_date' and D.station_id = '$station_id' ";
        ...
        where  A.order_status_id in (2,5,6,8) and A.order_deliver_status_id in (1,2) and A.area_id = '$area_id'and A.deliver_date = '$search_date'and D.station_id = '$station_id' ";
