        ...
        <div id="inv_control" align="center">
            <div id="invMethods">
               ...
               <button id="inventoryVegCheck" class="invopt" style="display: inline" onclick="javascript:inventoryMethodHandler('inventoryVegCheck');">蔬菜库存盘点</button>
                 ...
                 <?php } ?>
                <div></div> <button id="locationVerification" class="invopt" style="display: block" onclick="javascript:location='location_verifi.php?auth=xsj2015inv&ver=db'">货位核查</button> </div>
