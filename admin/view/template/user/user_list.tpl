              ...
              <tbody>
                ...
                <tr>
                  <td class="text-center"><?php if (in_array($user['user_id'], $selected)) { ?>
                    ...
                    <?php } ?></td>
                    <td class="text-left" title="<?php echo "组ID: ".$user['user_group_id']; ?>"><?php echo $user['group_name']; ?></td>
                    <td class="text-left"><?php echo $user['user_title']; ?></td>
