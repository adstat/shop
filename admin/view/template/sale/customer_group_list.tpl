            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <td class="text-left"><?php if ($sort == 'cgd.name') { ?>
                    ...
                    <?php } ?></td>
                  <td class="text-left">升级订单数</td>
                  <td class="text-left">升级金额</td>
                  <td class="text-left">获取优惠券金额</td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer_group['aim_orders']; ?></td>
                  <td class="text-left"><?php echo $customer_group['aim_totals']; ?></td>
                  <td class="text-left"><?php echo $customer_group['discount_total']; ?></td>
