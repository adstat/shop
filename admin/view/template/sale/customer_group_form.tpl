    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-customer-group" class="form-horizontal">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sort-order">升级订单数</label>
            <div class="col-sm-2">
              <input type="number" min="0" name="aim_orders" value="<?php echo $aim_orders; ?>" id="input-aim_orders" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sort-order">升级金额</label>
            <div class="col-sm-2">
              <input type="number" name="aim_totals" value="<?php echo $aim_totals; ?>" id="input-aim_totals" class="form-control" />
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="input-sort-order">获取优惠券金额</label>
            <div class="col-sm-2">
              <input type="number" name="discount_total" value="<?php echo $discount_total; ?>" id="input-discount_total" class="form-control" />
            </div>
          </div>
          <div class="form-group">
