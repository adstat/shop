    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
          <ul class="nav nav-tabs">
            <li class="active"><a href="#tab-general" data-toggle="tab">重置库存</a></li>
            ...
            <div class="tab-pane active" id="tab-general">
              <div class="tab-content">
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-upload-xls">上传excel</label>
                      <div class="col-sm-10">
                        <input type="file" name="file" id="input-upload-xls" class="form-control">
                      </div>
                  </div>
                  <div class="form-group">
                      <label class="col-sm-2 control-label">21:30-23:59期间可以上传</label>
                      <div class="col-sm-10">
                          <?php $now = (int)date("Hi", time()+8*3600); if( ($now >= 2130 || $now < 2359)){ ?>
                  ...
                  <form action="<?php echo $action_adjust; ?>" method="post" enctype="multipart/form-data" id="form-product-adjust" class="form-horizontal">
                    <table id="adjust" class="table table-striped table-bordered table-hover">
                      ...
                      <tr>
                            ...
                            <td class="text-center" width="10%">平台</td>
                      ...
                      <tr>
                          <td colspan="7" class="text-center"><button type="button" class="btn btn-primary" onclick="submitAdjust();">确认调整</button></td>
                      </tr>
                      </tfoot>
                    </table>
                  </form>
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                $.each(data, function(i, n){
                    ...
                    html += '  <td class="text-center" ' + bgColor + '>' + n.station + '</td>';
