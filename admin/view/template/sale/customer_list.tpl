            ...
            <table class="table table-bordered table-hover">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-left"><?php echo $customer['name']; if($customer['remark']){ echo "<br /><i>[内部备注：". $customer['remark']."]</i>"; } ?></td>
                  ...
                  <td class="text-center"><?php echo $customer['orderid'] ? $customer['orderid'].'('.$customer['order_date_added'].')' : ''; ?></td>
