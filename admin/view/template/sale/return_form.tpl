          ...
          <div class="tab-pane active" id="tab-general">
            ...
            <fieldset>
              ...
              <tbody>
                ...
                <?php foreach ($return_products as $product) { ?>  
                    <tr>
                        <td class="text-left"><a target="_blank" href="<?php echo $product['order_url'];?>"><?php echo $product['order_id']; ?></a></td>
                      <td class="text-left"><?php echo $product['rp_product_id']; ?></td>
                      <td class="text-left"><a target="_blank" href="<?php echo $product['product_url'];?>"><?php echo $product['rp_product'];?></a></td>
                      <td class="text-right" id="pro_quantity_1574"><?php echo $product['rp_quantity'];?></td>
                      <td class="text-right"><?php echo $product['in_part'] ? '散件退'.$product['rp_quantity'].'整箱数'.$product['box_quantity'].'系统结算'.round($product['rp_quantity']/$product['box_quantity'],2) : $product['rp_quantity']; ?></td>
                      <td class="text-right">¥<?php echo $product['rp_price'];?></td>
                      <td class="text-right">¥<?php echo $product['return_product_credits'];?></td>
                      <td class="text-right"><?php echo $product['return_product_desc'];?></td>
                      <td class="text-right"><?php echo $product['return_product_action'];?></td>
