      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
          ...
          <div class="tab-pane active" id="tab-general">
              ...
              <div style="margin: 10px 10px 0 10px; padding: 10px 10px 0 10px; border: 1px dashed #9c9c9c">
              <div style="font-size: 16px; font-style: italic; font-weight: bold">基础商品数据</div>
              
              
              
              <div class="form-group">
                    
                <label class="col-sm-2 control-label" for="input-product-sku">商品原料<span style="color:red;">(不能选错，不能修改，重要！)</span></label>
                ...
                <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-weight-inv-flag">按重出库<span style="color:red;">(不能修改)</span></label>
                <div class="col-sm-10">
                  ...
                  <div class="form-group required">
                      <label class="col-sm-2 control-label" for="input-purchase-cost" title="每斤或每件当天采购价">按斤采购价(当天采购价)</label>
                      <div class="col-sm-10">
                          <input type="text" name="purchase_cost" value="<?php echo $purchase_cost; ?>" placeholder="最小单位采购价" id="input-purchase-cost" class="form-control" onchange="updateUnitPrice()" />
                      </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-warehouse-cost" title="仓库成本默认0.2元，非诚勿改。">仓库成本<br/ >(默认: 0.2元)</label>
                      <div class="col-sm-3">
                          <input type="text" name="warehouse_cost" value="<?php echo $warehouse_cost; ?>" placeholder="仓库成本(默认0.2元)" id="input-warehouse-cost" class="form-control" />
                      </div>


                      <label class="col-sm-2 control-label" for="input-repack-cost" title="重新包装成本默认0.1元，非诚勿改。">重新包装成本<br/ >(默认: 0.1元)</label>
                      <div class="col-sm-3">
                          <input type="text" name="repack_cost" value="<?php echo $repack_cost; ?>" placeholder="重新包装成本(默认0.1元)" id="input-repack-cost" class="form-control" />
                      </div>
                  </div>

                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-unit-price" title="采购价，仓库成本，重新包装成本之和">最小单位价格(自动计算)</label>
                      <div class="col-sm-10">
                          <input type="text" name="unit_price" value="<?php echo $unit_price; ?>" placeholder="最小单位价格" id="input-unit-price" class="form-control" />
                      </div>
                  </div>

                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-fix-discount" title="仓库成本或包装成本的负值，限指定商品">固定折扣<br />(负值，限指定商品)</label>
                      <div class="col-sm-10">
                          <input type="text" name="fix_discount" value="<?php echo $fix_discount; ?>" placeholder="固定折扣" id="input-fix-discount" class="form-control" />
                      </div>
                  </div>

                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-price">价格(自动计算)</label>
                      <div class="col-sm-10">
                  ...
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="input-weight">分拣重量</label>
                      <div class="col-sm-3">
                          <input type="text" name="weight" value="<?php echo $weight; ?>" placeholder="??" id="input-weight" class="form-control" />
                      </div>
                  ...
                  <div class="form-group">
                      ...
                      <div class="col-sm-10">
                          ...
                          <div id="product-category" class="well well-sm" style="height: 50px; overflow: auto; margin-bottom:0px;">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="language<?php echo $language['language_id']; ?>">
                  <div class="form-group required">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-tag<?php echo $language['language_id']; ?>"><span data-toggle="tooltip" title="行业内对此商品的其他称呼">商品别名</span></label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-description<?php echo $language['language_id']; ?>">品相描述</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="product_description[<?php echo $language['language_id']; ?>][description]" placeholder="描述" id="input-description<?php echo $language['language_id']; ?>"><?php echo isset($product_description[$language['language_id']]) ? $product_description[$language['language_id']]['description'] : ''; ?></textarea>
                        </div>
                    </div>
            ...
            <div class="tab-pane" id="tab-data">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                   ...
                   <?php if (isset($error_sku)) { ?>
                      <div class="col-sm-10 text-danger"><?php echo $error_sku; ?></div>
                      <?php } ?>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  <label class="col-sm-2 control-label" for="input-manufacturer"><span data-toggle="tooltip" title="(输入时自动筛选结果)">制造商/产地</span></label>
                  <div class="col-sm-10">
                      <input type="text" name="manufacturer" value="<?php echo $manufacturer ?>" placeholder="制造商/产地" id="input-manufacturer" class="form-control" />
            ...
            -->
              ...
              <div class="form-group"  style="display: none">
                  <label class="col-sm-2 control-label" for="input-package-weight">包装重量</label>
                  <div class="col-sm-10">
                      <input type="text" name="package_weight" value="<?php echo $package_weight; ?>" placeholder="包装重量" id="input-package-weight" class="form-control" />
                  </div>
              </div>   
...
//--></script> 
  ...
  function updateUnitPrice(){
      var purchaseCost = parseFloat($('#input-purchase-cost').val());
      var warehouseCost = parseFloat($('#input-warehouse-cost').val());
      var repackCost = parseFloat($('#input-repack-cost').val());
      var unitSize = parseInt($('#input-unit-size').val());

      var unitPrice = purchaseCost+warehouseCost+repackCost;
      var price = unitPrice*unitSize;

      $('#input-unit-price').val(unitPrice.toFixed(2));
