      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
          <ul class="nav nav-tabs">
            ...
            <li style="display: none"><a href="#tab-data" data-toggle="tab"><?php echo $tab_data; ?></a></li>
            <li style="display: none"><a href="#tab-design" data-toggle="tab"><?php echo $tab_design; ?></a></li>
          </ul>

          <div class="form-group" style="border: 1px #333 dashed; padding: 5px; margin: 8px 3px; background-color: #fff9df;">
