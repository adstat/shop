      ...
      <div class="panel-body">
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover">
                <caption style="font-style: italic; font-size: 1.2em">正准备导入<span style="font-size: 1.3em; font-weight: bold; color: #FF3300"><?php echo $purchase_date; ?></span>采购数据，已有日期数据将被覆盖</caption>
                <thead>
                    <tr>
                        ...
                        <td class="text-center" style="color: #CC0000">蔬果毛重价</td>
                        <td class="text-center">采购金额500g</td>
                        <td class="text-center">采购数量500g</td>
                        <td class="text-center">采购合计</td>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-right" colspan="8">
                            <div style="font-style: italic; font-size: 1.2em">正准备导入<span style="font-size: 1.3em; font-weight: bold; color: #FF3300"><?php echo $purchase_date; ?></span>采购数据，已有日期数据将被覆盖</div>
