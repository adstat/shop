  ...
  <div class="container-fluid">
    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h3 class="panel-title"><i class="fa fa-pencil"></i>原料价格维护</h3>
      </div>
      <div class="panel-body">
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-hover">
                <caption style="font-style: italic; font-size: 1.1em">正准备导入原料价格数据，当日已上传同商品编号数据将被覆盖
                    <br />
                    <span style="background-color: #fadb4e">颜色高亮</span>表示名称或原价与当前系统不符。</caption>
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-right" colspan="12">
                            <div style="font-style: italic; font-size: 1.2em">正准备导入原料价格数据，当日已上传同商品编号数据将被覆盖</div>
