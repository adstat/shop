...
<div id="content">
  ...
  <div class="container-fluid">
      ...
      <div class="panel-body">
        <div class="table-responsive">
            <form action="<?php echo $action_confirm; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
                ...
                <input type="hidden" name="inventory_plan_date" value="<?php echo $inventory_plan_date; ?>">
            </form>
            <table class="table table-bordered table-hover">
                <caption style="font-style: italic; font-size: 1.2em">正准备导入<span style="font-size: 1.3em; font-weight: bold; color: #FF3300"><?php echo $inventory_plan_date; ?></span>预设库存数据，已有日期数据将被覆盖</caption>
                <thead>
                    <tr>
                        <td class="text-center">序号</td>
                        <td class="text-center">商品编号</td>
                        <td class="text-center">商品名称</td>
                        <td class="text-center" style="background-color: #f0ad4e;">系统商品名称</td>
                        <td class="text-center">预设数量</td>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        <td class="text-right" colspan="8">
                            <div style="font-style: italic; font-size: 1.2em">正准备导入<span style="font-size: 1.3em; font-weight: bold; color: #FF3300"><?php echo $inventory_plan_date; ?></span>预设库存数据，已有日期数据将被覆盖</div>
    ...
    <script type="text/javascript">
        function submitForm(){
            if(window.confirm('确认提交此预设库存数据吗？')){
                $('#form-product').submit();
            }
        }
    </script>
