...
class ControllerCommonMenu extends Controller {
	...
	public function index() {
		...
		$data['text_home_notice'] = $this->language->get('text_home_notice');
		...
		$data['text_financial_confirm'] = $this->language->get('text_financial_confirm');
		...
		$data['text_vmipurchase'] = $this->language->get('text_vmipurchase');
		...
		$data['text_report_warehouse_distribution'] = $this->language->get('text_report_warehouse_distribution');
		$data['text_report_product_sale'] = $this->language->get('text_report_product_sale');
		$data['text_report_product_detail'] = $this->language->get('text_report_product_detail');

		$data['text_report_customer_info'] = $this->language->get('text_report_customer_info');
		$data['text_report_purchase_order'] = $this->language->get('text_report_purchase_order');
		$data['text_report_purchase_detail'] = $this->language->get('text_report_purchase_detail');			
		$data['text_report_logistic_info'] = $this->language->get('text_report_logistic_info');
		$data['text_report_logistic_driver'] = $this->language->get('text_report_logistic_driver');
		...
		$data['text_index_promotion'] = $this->language->get('text_index_promotion');
		$data['text_BD'] = $this->language->get('text_BD');
		$data['text_order_instead'] = $this->language->get('text_order_instead');
		...
		$data['financial_confirm'] = $this->url->link('sale/financial_confirm', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['product_history'] = $this->url->link('catalog/product_history', 'token=' . $this->session->data['token'], 'SSL');

		$data['inventory_plan']=$this->url->link('purchase/inventory_plan','token='.$this->session->data['token'],'SSL');
		$data['vmipurchase']=$this->url->link('purchase/vmipurchase','token='.$this->session->data['token'],'SSL');
                
                
                $data['sku'] = $this->url->link('catalog/sku', 'token=' . $this->session->data['token'], 'SSL');
                $data['supplier'] = $this->url->link('catalog/supplier', 'token=' . $this->session->data['token'], 'SSL');
                $data['balance'] = $this->url->link('catalog/balance', 'token=' . $this->session->data['token'], 'SSL');

		$data['priceApplication'] = $this->url->link('catalog/product_mannage', 'token=' . $this->session->data['token'], 'SSL');
		$data['priceExzamine'] = $this->url->link('catalog/product_application', 'token=' . $this->session->data['token'], 'SSL');
		$data['exzamine'] = $this->url->link('catalog/exzamine', 'token=' . $this->session->data['token'], 'SSL');

		$data['product_skubarcode'] = $this->url->link('catalog/product_skubarcode', 'token=' . $this->session->data['token'], 'SSL');
		$data['product_inv'] = $this->url->link('catalog/product_inv', 'token=' . $this->session->data['token'], 'SSL');
		$data['activity'] = $this->url->link('catalog/activity', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_sale_order'] = $this->url->link('report/sale_order', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_bd_coupon'] = $this->url->link('report/bd_coupon','token=' . $this->session->data['token'], 'SSL');
		$data['report_inv_mi_cold'] = $this->url->link('report/inv_mi_cold', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['report_warehouse_distribution'] =  $this->url->link('report/warehouse_distribution', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_early_shipment'] =  $this->url->link('report/early_shipment', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_sorting_staff'] =  $this->url->link('report/sorting_staff', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_sorting_leader_shipment'] =  $this->url->link('report/sorting_leader_shipment', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['user_group'] = $this->url->link('user/user_permission', 'token=' . $this->session->data['token'], 'SSL');
                ...
                $data['w_user'] = $this->url->link('user/w_user', 'token=' . $this->session->data['token'], 'SSL');
                $data['container'] = $this->url->link('user/container', 'token=' . $this->session->data['token'], 'SSL');
                $data['container_w'] = $this->url->link('user/container_w', 'token=' . $this->session->data['token'], 'SSL');
		$data['warehouse_distribution'] = $this->url->link('user/warehouse_distribution', 'token=' . $this->session->data['token'], 'SSL');
		$data['warehouse_management'] = $this->url->link('user/warehouse_management', 'token=' . $this->session->data['token'] .'&filter_warehouse_id_global=' , 'SSL');
		$data['warehouse_sorting'] = $this->url->link('user/warehouse_sorting', 'token=' . $this->session->data['token'], 'SSL');
                $data['return_product'] = $this->url->link('user/return_product', 'token=' . $this->session->data['token'], 'SSL');
		$data['inventory_order_missing'] = $this->url->link('user/inventory_order_missing', 'token=' . $this->session->data['token'], 'SSL');
				$data['sort_error'] = $this->url->link('user/sort_error', 'token=' . $this->session->data['token'], 'SSL');
        ...
        $data['report_sale_station'] = $this->url->link('report/sale_station', 'token=' . $this->session->data['token'], 'SSL');
        $data['report_sale_stat'] = $this->url->link('report/sale_stat', 'token=' . $this->session->data['token'], 'SSL');
		$data['report_product_sale'] = $this->url->link('report/product_sale','token='. $this->session->data['token'], 'SSL');
		$data['report_customer_info'] = $this->url->link('report/customer_info','token='. $this->session->data['token'], 'SSL');
		$data['report_logistic_driver_total'] = $this->url->link('report/driver_total','token='. $this->session->data['token'], 'SSL');

		$data['report_purchase_order'] = $this->url->link('report/purchase_order','token='. $this->session->data['token'], 'SSL');
		$data['report_purchase_detail'] = $this->url->link('report/purchase_detail','token='. $this->session->data['token'], 'SSL');
		$data['report_logistic_info'] = $this->url->link('report/logistic_info','token='. $this->session->data['token'], 'SSL');
		$data['report_logistic_driver'] = $this->url->link('report/logistic_driver','token='. $this->session->data['token'], 'SSL');
        $data['inventory'] = $this->url->link('catalog/inventory', 'token=' . $this->session->data['token'], 'SSL');
        $data['inventory_fresh'] = $this->url->link('catalog/inventory/index_fresh', 'token=' . $this->session->data['token'], 'SSL');
        $data['purchase'] = $this->url->link('purchase/purchase', 'token=' . $this->session->data['token'], 'SSL');

        $data['pre_purchase'] = $this->url->link('purchase/pre_purchase', 'token=' . $this->session->data['token'], 'SSL');
		$data['pre_purchase_adjust'] = $this->url->link('purchase/pre_purchase_adjust', 'token=' . $this->session->data['token'], 'SSL');
		$data['warehouse_allocation_note'] = $this->url->link('purchase/warehouse_allocation_note', 'token=' . $this->session->data['token'].'&filter_warehouse_id_global=' , 'SSL');
		$data['upload_pre_purchase'] = $this->url->link('purchase/pre_purchase_upload', 'token=' . $this->session->data['token'], 'SSL');
		$data['product_price'] = $this->url->link('catalog/product_price', 'token=' . $this->session->data['token'], 'SSL');
        
        $data['order_replenish'] = $this->url->link('sale/order_replenish', 'token=' . $this->session->data['token'], 'SSL');

        $data['report_sale_customer_active'] = $this->url->link('report/sale_customer_active', 'token=' . $this->session->data['token'], 'SSL');

		$data['report_bd_perforemance'] = $this->url->link('report/sale_bd_perforemance', 'token=' . $this->session->data['token'], 'SSL');

        //Logistic Menu Settings
        $data['logistic_allot'] = $this->url->link('logistic/logistic_allot', 'token=' . $this->session->data['token'], 'SSL');
		$data['logistic_allot2'] = $this->url->link('logistic/logistic_allot2', 'token=' . $this->session->data['token'], 'SSL');
        $data['logistic_allot_order'] = $this->url->link('logistic/logistic_allot_order', 'token=' . $this->session->data['token'], 'SSL');
        $data['logistic_allot_van'] = $this->url->link('logistic/logistic_allot_van', 'token=' . $this->session->data['token'], 'SSL');
        $data['logistic_info'] = $this->url->link('logistic/logistic_info', 'token=' . $this->session->data['token'], 'SSL');
		...
		$data['home_notice'] = $this->url->link('notice/homenotice', 'token=' . $this->session->data['token'], 'SSL');
        $data['promotion'] = $this->url->link('marketing/promotion', 'token=' . $this->session->data['token'], 'SSL');

        //Area
        $data['area'] = $this->url->link('marketing/area', 'token=' . $this->session->data['token'], 'SSL');

        //Marketing Sms Pin Code Query
        $data['smspin_query'] = $this->url->link('marketing/smspin_query', 'token=' . $this->session->data['token'], 'SSL');

		$data['index_promotion'] = $this->url->link('marketing/index_promotion', 'token=' . $this->session->data['token'], 'SSL');
		$data['bd'] = $this->url->link('marketing/bd', 'token=' . $this->session->data['token'], 'SSL');
		$data['order_instead'] = $this->url->link('marketing/order_instead', 'token=' . $this->session->data['token'], 'SSL');
		$data['customer_price'] = $this->url->link('marketing/customer_price', 'token=' . $this->session->data['token'], 'SSL');
		$data['customer_activity'] = $this->url->link('marketing/customer_activity', 'token=' . $this->session->data['token'], 'SSL');
