...
class ControllerSaleCustomerGroup extends Controller {
	...
	protected function getList() {
		...
		foreach ($results as $result) {
			$data['customer_groups'][] = array(
				...
				'aim_orders' => $result['aim_orders'],
				'aim_totals' => $result['aim_totals'],
	...
	protected function getForm() {
		...
		if (isset($this->request->post['aim_orders'])) {
			$data['aim_orders'] = $this->request->post['aim_orders'];
		} elseif (!empty($customer_group_info)) {
			$data['aim_orders'] = $customer_group_info['aim_orders'];
		} else {
			$data['aim_orders'] = '';
		}

		if (isset($this->request->post['aim_totals'])) {
			$data['aim_totals'] = $this->request->post['aim_totals'];
		} elseif (!empty($customer_group_info)) {
			$data['aim_totals'] = $customer_group_info['aim_totals'];
		} else {
			$data['aim_totals'] = '';
		}

		if (isset($this->request->post['discount_total'])) {
			$data['discount_total'] = $this->request->post['discount_total'];
		} elseif (!empty($customer_group_info)) {
			$data['discount_total'] = $customer_group_info['discount_total'];
		} else {
			$data['discount_total'] = '';
		}
