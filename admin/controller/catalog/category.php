...
class ControllerCatalogCategory extends Controller {
    ...
    public function getUrlParam(){
        ...
        if (isset($this->request->get['filter_parent_category'])) {
            $url .= '&filter_parent_category=' . $this->request->get['filter_parent_category'];
        }
	...
	protected function getList() {
        ...
        if (isset($this->request->get['filter_parent_category'])) {
            $filter_parent_category = $this->request->get['filter_parent_category'];
        }
        else{
        ...
        $data['filter_parent_category'] = $filter_parent_category;
        ...
        $data['parentCategoryList'] = array();
        $parentCategoryList = $this->model_catalog_category->getParentCategoryList();
        foreach($parentCategoryList as $m){
            $data['parentCategoryList'][] = array(
                'category_id' => $m['category_id'],
                'category_name' => $m['category_name'],
                'station' => $data['stations'][$m["station_id"]]['name']
            );
        }
        ...
        foreach ($results as $result) {
			$data['categories'][] = array(
				...
				'name'        => $result['name'],
                'station'     => $data['stations'][$result["station_id"]]['name'],
		...
		$data['sort_category_id'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'] . '&sort=category_id' . $url, 'SSL');
		...
		$data['sort_station_id'] = $this->url->link('catalog/category', 'token=' . $this->session->data['token'] . '&sort=station_id' . $url, 'SSL');
	...
	protected function getForm() {
        ...
        if (!empty($category_info)) {
            $data['station_id'] = $category_info['station_id'];
        }
        else if(isset($this->request->get['filter_station'])){
            $data['station_id'] = $this->request->get['filter_station'];
        }
        else {
            $data['station_id'] = 0;
        }
