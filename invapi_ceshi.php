...
define('APIURL', SITE_URI . '/api/xmlrpc/v1/index_warehouseceshi.php');
...
if($method == 'getPurchaseOrders'){
    ...
    $data['handle_product'] = !empty($_POST['handle_product']) ? $_POST['handle_product'] : '';
...
if($method == 'addFastMoveSortingToInv'){
    ...
    $data = array(
        ...
        'inv_spare_comment' => isset($_POST['inv_spare_comment']) ? $_POST['inv_spare_comment'] : 0,
...
if($method == 'inventory_login'){
    ...
    if($return['status'] == 1){
        ...
        setcookie("user_group_id" , $return['user']['user_group_id'],time()+2*3600+8*3600);
        setcookie("warehouse_repack" , $return['user']['warehouse_repack'],time()+2*3600+8*3600);
        setcookie("user_repack" , $return['user']['user_repack'],time()+2*3600+8*3600);
        exit(json_encode($return));
    }
